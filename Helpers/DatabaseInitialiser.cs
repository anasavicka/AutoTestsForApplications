    ...
    public static class DatabaseInitializer
    {
            ...
            SqliteConnection connection)
        {
            ...
            var addresses = new[]
            {
                ...
                new
                {
                    UserId = 2, City = "Санкт-Петербург", Street = "Невский проспект", House = "15", Apartment = "41"
                },
            ...
            SqliteConnection connection)
        {
            ...
            var reviews = new[]
            {
                ...
                new
                {
                    UserId = 2, ProductId = 3, Rating = 4, Comment = "За свои деньги хороший вариант",
                    CreatedAt = "2026-01-25"
                },
                new
                {
                    UserId = 4, ProductId = 8, Rating = 5, Comment = "Очень хорошие наушники", CreatedAt = "2026-02-10"
                },
                ...
                new
                {
                    UserId = 7, ProductId = 16, Rating = 5, Comment = "Очень удобная мышь", CreatedAt = "2026-03-10"
                },
                ...
                new
                {
                    UserId = 10, ProductId = 1, Rating = 5, Comment = "Очень доволен покупкой", CreatedAt = "2026-04-15"
                },
                ...
                new
                {
                    UserId = 15, ProductId = 10, Rating = 5, Comment = "Отличный телевизор", CreatedAt = "2026-06-10"
                },
